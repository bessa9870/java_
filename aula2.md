...
```
Como visto a cima, não há problema declarar a constante vazia, contanto que ela vá ser iniciada em um construtor, uma vez definido o valor do `final`, o JAVA não aceitará em hipótese alguma, uma mudança nesse valor, resultando em erro de compilação.
